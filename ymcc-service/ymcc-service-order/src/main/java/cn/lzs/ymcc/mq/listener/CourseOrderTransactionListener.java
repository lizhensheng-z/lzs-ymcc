package cn.lzs.ymcc.mq.listener;
...
@RocketMQTransactionListener(
        txProducerGroup = RocketMQConstants.MQ_COURSEORDER_PAY_GROUP_TRANSACTION
)
    ...
    public RocketMQLocalTransactionState executeLocalTransaction(Message message, Object args) {
        ...
        try {
          ...
          return RocketMQLocalTransactionState.COMMIT;
            ...
            e.printStackTrace();
            log.error("事务监听器 保存订单出现异常 {}" ,e.getMessage());
        }
        log.info("事务消息回滚");
        return RocketMQLocalTransactionState.ROLLBACK;
    }
